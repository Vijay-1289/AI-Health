...
const NearbyHospitals = () => {
  ...
  const getDirections = (hospital: HospitalInfo) => {
    ...
    const url = `https://www.google.com/maps/dir/?api=1&origin=${currentLocation.lat},${currentLocation.lng}&destination=${encodeURIComponent(hospital.name + ', ' + hospital.city)}&travelmode=driving`;
